    ...
    <PageLayout>
      ...
      >
        ...
        <section className="mb-12">
          <h2 className="text-xl font-bold mb-4 text-gray-200">Routing</h2>
              ...
              <tbody className="text-gray-300">
                {[
                  ...
                  <tr key={input} className="border-t border-[var(--color-border)]">
                    <td className="p-3 font-[var(--font-mono)] text-[var(--color-accent-light)]">{input}</td>
        ...
        {/* Install */}
        <section className="mb-12">
          <h2 className="text-xl font-bold mb-4 text-gray-200">Install</h2>
...
cp "$SRC/enhance-gpt/SKILL.md"    ~/.cursor/skills/enhance-gpt/`}</CodeBlock>
          <p className="text-[var(--color-muted)] text-sm mt-3">
            Start a new conversation after installing — skills are loaded at conversation start.
          </p>
        </section>
      </motion.div>
    </PageLayout>
